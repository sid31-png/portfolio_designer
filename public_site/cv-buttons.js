...
(function () {
  ...
  function boot() {
    // Mobile fixes live separately so future static exports can keep their
    // generated bundles untouched. Load them before the enhancement observer.
    if (!document.querySelector('link[href$="assets/mobile-fixes.css"]')) {
      var mobileCss = document.createElement('link');
      mobileCss.rel = 'stylesheet';
      mobileCss.href = BASE + 'assets/mobile-fixes.css';
      document.head.appendChild(mobileCss);
    }
    if (!document.querySelector('script[src$="assets/mobile-fixes.js"]')) {
      var mobileScript = document.createElement('script');
      mobileScript.src = BASE + 'assets/mobile-fixes.js';
